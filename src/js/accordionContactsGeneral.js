const characteristicsListElem = document.querySelector('.contacts-general__accordion');
const characteristicsItemElems = document.querySelectorAll('.contacts-general__accordion .accordion__item');
